...
namespace MonoGame.Extended.Entities
{
    public class EntityManager : UpdateSystem
    {
        ...
        public EntityManager(ComponentManager componentManager)
        {
            ...
            _entityToComponentBits = new Bag<long>(_defaultBagSize);
        ...
        private readonly Bag<long> _entityToComponentBits;
        ...
        public long GetComponentBits(int entityId)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            foreach (var entityId in _removedEntities)
            {
                ...
                _entityToComponentBits[entityId] = 0;
                ActiveCount--;
